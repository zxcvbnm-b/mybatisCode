...
DROP TABLE comment;DROP TABLE authorb;
DROP TABLE post_tag;DROP TABLE authorb;
DROP TABLE tag;DROP TABLE authorb;
DROP TABLE post;DROP TABLE authorb;
DROP TABLE blog;
DROP TABLE author;DROP TABLE authorb;
