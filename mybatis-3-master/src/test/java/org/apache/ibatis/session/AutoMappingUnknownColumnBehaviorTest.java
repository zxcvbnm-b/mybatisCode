...
import org.apache.ibatis.domain.blog.mappers.TestMapper;
...
class AutoMappingUnknownColumnBehaviorTest {
    ...
    public static UnpooledDataSource createUnpooledDataSource() throws IOException {
      UnpooledDataSource ds = new UnpooledDataSource();
      ds.setDriver("com.mysql.jdbc.Driver");
      ds.setUrl("jdbc:mysql://localhost:3306/album?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai");
      ds.setUsername("root");
      ds.setPassword("051515");
      return ds;
    }
    @BeforeAll
    static void setup() throws Exception {
        DataSource dataSource = createUnpooledDataSource();
    ...
    void none() {
        ...
        try (SqlSession session = sqlSessionFactory.openSession()) {
          ...
          TestMapper mapper1 = session.getMapper(TestMapper.class);
           List<TestEntity> testEntity = mapper1.selectText();
          System.out.println(testEntity.size());
