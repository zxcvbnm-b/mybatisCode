...
class XPathParserTest {
  ...
  void formatXNodeToString() {
    XPathParser parser = new XPathParser("<users>xxxxrrrr<user>xxxx<id>xxxx100</id><name>Tom</name><age>30</age><cars><car index=\"1\">BMW</car><car index=\"2\">Audi</car><car index=\"3\">Benz</car></cars></user>xxxxrrrr</users>");
    List<XNode> children = parser.evalNode("/users").getChildren();
