...
public class XNode {
  ...
  public String getValueBasedIdentifier() {
    ...
    while (current != null) {
      ...
      /*先从配置对象中获取property的值，再从value获取值，然再从id获取值，优先顺序是：id,value,property*/
  ...
  /*解析xml的属性值放到 Properties中 比如I D=“xxx”  并存到Properties中去用于后续获取*/
  ...
  /*获取xml文件的文本数据 比如<ID>xxxx</ID>中的 xxxx 不包括子标签？ 如果有子标签呢 ？比如<ID>xxxx<if>/</if></ID>。返回 CDATA_SECTION_NODE类型是转义符*/
